---
## Front matter
title: "Прохождение внешнего курса. Часть 1. Основы системного администрирования и Linux"
subtitle: "Отчёт"
...
![«Роль системного администратора Linux». Вопрос №1](image/2.PNG){#fig:002 width=90%}
...
![«Роль системного администратора Linux». Вопрос №2](image/3.PNG){#fig:003 width=90%}
...
![«Роль системного администратора Linux». Вопрос №3](image/4.PNG){#fig:004 width=90%}
...
![«Вводный урок». Условия заданий](image/5.PNG){#fig:005 width=90%}
...
![Установка htop](image/z1.PNG){#fig:006 width=90%}
...
![Фильтрация процессов htop](image/z2.PNG){#fig:007 width=90%}
...
![Размер файловых систем на диске](image/z3.PNG){#fig:008 width=90%}
...
![Размер подкаталогов /var](image/z4.PNG){#fig:009 width=90%}

### Тест по теме «Вводный урок»

![Подтверждение прохождения теста «Вводный урок»](image/6.PNG){#fig:010 width=90%}

![«Вводный урок». Вопрос №1](image/7.PNG){#fig:011 width=90%}
...
![«Вводный урок». Вопрос №2](image/8.PNG){#fig:012 width=90%}
...
![«Вводный урок». Вопрос №3](image/9.PNG){#fig:013 width=90%}
...
![«Роль командной строки в серверной среде». Условия заданий](image/10.PNG){#fig:014 width=90%}
...
![Журнал с сообщениями ядра](image/z5.PNG){#fig:015 width=90%}
...
![Статус службы SSH](image/z6.PNG){#fig:016 width=90%}
...
![Список всех активных служб](image/z7.PNG){#fig:017 width=90%}

### Тест по теме «Роль командной строки в серверной среде»

![Подтверждение прохождения теста «Роль командной строки в серверной среде»](image/11.PNG){#fig:018 width=90%}

![«Роль командной строки в серверной среде». Вопрос №1](image/12.PNG){#fig:019 width=90%}
...
![«Роль командной строки в серверной среде». Вопрос №2](image/13.PNG){#fig:020 width=90%}
...
![«Роль командной строки в серверной среде». Вопрос №3](image/14.PNG){#fig:021 width=90%}
...
![«Файловая структура и ключевые каталоги». Условия заданий (1)](image/15.PNG){#fig:022 width=90%}
...
![Поиск конфигурационного файла SSH](image/z8.PNG){#fig:023 width=90%}
...
![Файл конфигурации SSH](image/z9.PNG){#fig:024 width=90%}
...
![Журналы каталога /var/log](image/z10.PNG){#fig:025 width=90%}
...
![«Файловая структура и ключевые каталоги». Условия заданий (2)](image/16.PNG){#fig:026 width=90%}
...
![Последние 20 записей journalctl](image/z11.PNG){#fig:027 width=90%}
...
![Сторонние пакеты каталога /opt](image/z12.PNG){#fig:028 width=90%}
...
![Имитация процесса настройки nginx](image/z13.PNG){#fig:029 width=90%}

### Тест по теме «Файловая структура и ключевые каталоги»

![Подтверждение прохождения теста «Файловая структура и ключевые каталоги»](image/17.PNG){#fig:030 width=90%}

![«Файловая структура и ключевые каталоги». Вопрос №1](image/18.PNG){#fig:031 width=90%}
...
![«Файловая структура и ключевые каталоги». Вопрос №2](image/19.PNG){#fig:032 width=90%}
...
![«Файловая структура и ключевые каталоги». Вопрос №3](image/20.PNG){#fig:033 width=90%}
...
![«Принцип „Всё есть файл“». Условия заданий](image/21.PNG){#fig:034 width=90%}
...
![Просмотр информации о процессоре](image/z14.PNG){#fig:035 width=90%}
...
![Просмотр информации о процессоре](image/z15.PNG){#fig:036 width=90%}
...
![Просмотр каталога /dev](image/z16.PNG){#fig:037 width=90%}
...
![Подтверждение прохождения теста «Принцип „Всё есть файл“»](image/22.PNG){#fig:038 width=90%}

![«Принцип „Всё есть файл“». Вопрос №1](image/23.PNG){#fig:039 width=90%}
...
![«Принцип „Всё есть файл“». Вопрос №2](image/24.PNG){#fig:040 width=90%}
...
![«Принцип „Всё есть файл“». Вопрос №3](image/25.PNG){#fig:041 width=90%}
...
![«Работа с базовыми командами в реальных условиях». Условия заданий](image/26.PNG){#fig:042 width=90%}

#### Задание №1

Текущей каталог доступен командой ```pwd```.

![Текущий каталог](image/z17.PNG){#fig:043 width=90%}
...
![Скрытые файлы домашнего каталога](image/z18.PNG){#fig:044 width=90%}
...
![Последние 10 записей messages, связаных с сервисом systemd](image/z19.PNG){#fig:045 width=90%}

### Тест по теме «Работа с базовыми командами в реальных условиях»

![Подтверждение прохождения теста «Работа с базовыми командами в реальных условиях»](image/27.PNG){#fig:046 width=90%}

![«Работа с базовыми командами в реальных условиях». Вопрос №1](image/28.PNG){#fig:047 width=90%}
...
![«Работа с базовыми командами в реальных условиях». Вопрос №2](image/29.PNG){#fig:048 width=90%}
...
![«Работа с базовыми командами в реальных условиях». Вопрос №3](image/30.PNG){#fig:049 width=90%}
...
![«Работа с базовыми командами в реальных условиях». Вопрос №4](image/31.PNG){#fig:050 width=90%}
...
![«Работа с базовыми командами в реальных условиях». Вопрос №5](image/32.PNG){#fig:051 width=90%}
...
![«Базовые команды для управления файлами и каталогами». Условия заданий](image/33.PNG){#fig:052 width=90%}
...
![Создание каталога и его подкаталогов одной командой](image/z20.PNG){#fig:053 width=90%}
...
![Проверка наличия error.log и info.txt](image/z21.PNG){#fig:054 width=90%}
...
![Копирование файла из одного каталога в другой](image/z22.PNG){#fig:055 width=90%}
...
![Перемещение файлов](image/z23.PNG){#fig:056 width=90%}
...
![Удаление файлов и самого каталога project](image/z24.PNG){#fig:057 width=90%}

### Задания по теме «Работа с архивами и передача данных между серверами»

![«Работа с архивами и передача данных между серверами». Условия заданий](image/34.PNG){#fig:058 width=90%}
...
![Архивация файлов file](image/z25.PNG){#fig:059 width=90%}
...
![Извлечение файлов из архива](image/z26.PNG){#fig:060 width=90%}
...
![Запуск и проверка службы httpd](image/z27.PNG){#fig:061 width=90%}
...
![Практика команды scp](image/z28.PNG){#fig:062 width=90%}

### Тест по теме «Работа с архивами и передача данных между серверами»

![Подтверждение прохождения теста «Работа с архивами и передача данных между серверами»](image/35.PNG){#fig:063 width=90%}

![«Работа с архивами и передача данных между серверами». Вопрос №1](image/36.PNG){#fig:064 width=90%}
...
![«Работа с архивами и передача данных между серверами». Вопрос №2](image/37.PNG){#fig:065 width=90%}
...
![«Работа с архивами и передача данных между серверами». Вопрос №3](image/38.PNG){#fig:066 width=90%}
...
![«Основы автоматизации с помощью Bash-скриптов». Условия заданий](image/39.PNG){#fig:067 width=90%}
...
![Редактирование прав доступа clean_logs.sh](image/z29.PNG){#fig:068 width=90%}

![Выполнение файла clean_logs.sh](image/z30.PNG){#fig:069 width=90%}
...
![Настройка crontab -e](image/z31.PNG){#fig:070 width=90%}

### Тест по теме «Основы автоматизации с помощью Bash-скриптов»

![Подтверждение прохождения теста «Основы автоматизации с помощью Bash-скриптов»](image/40.PNG){#fig:071 width=90%}

![«Основы автоматизации с помощью Bash-скриптов». Вопрос №1](image/41.PNG){#fig:072 width=90%}
...
![«Основы автоматизации с помощью Bash-скриптов». Вопрос №2](image/42.PNG){#fig:073 width=90%}
...
![«Основы автоматизации с помощью Bash-скриптов». Вопрос №3](image/43.PNG){#fig:074 width=90%}
